                    ...
                    <div class="flex flex-row gap-6 mt-6 min-w-max">
                        <div class="p-4">
                            <a href="/menu-warung" class="block transform transition-transform hover:scale-105">
                                ...
                                <h1 class="text-slate-600 text-center font-semibold mt-2">nama warung</h1>
                            </a>
                        </div>
                    
                        <div class="p-4">
                            <a href="/menu-warung" class="block transform transition-transform hover:scale-105">
                                <img src="./assets/image/warung2.png" alt="" class="rounded-xl w-60">
                                <h1 class="text-slate-600 text-center font-semibold mt-2">nama warung</h1>
                            </a>
                        </div>
                        ...
                        <div class="p-4">
                            <a href="/menu-warung" class="block transform transition-transform hover:scale-105">
                                <img src="./assets/image/warung3.png" alt="" class="rounded-xl w-60">
                                <h1 class="text-slate-600 text-center font-semibold mt-2">nama warung</h1>
                            </a>
                        </div>
                        ...
                        <div class="p-4">
                            <a href="/menu-warung" class="block transform transition-transform hover:scale-105">
                                <img src="./assets/image/warung4.png" alt="" class="rounded-xl w-60">
                                <h1 class="text-slate-600 text-center font-semibold mt-2">nama warung</h1>
                            </a>
                        </div>
