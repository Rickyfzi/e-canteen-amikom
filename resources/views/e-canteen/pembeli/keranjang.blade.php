        ...
        <article class="w-[92%] mx-auto bg-white md:py-10 xs:py-4 xs:px-3 xl:px-16 gap-12 relative">
            ...
            <section class="py-4">
                ...
                <div class="flex justify-end mt-6 ">
                    <div>
                        <p class="">Total harga: <span class="text-2xl text-purple-900">Rp</span> <span id="total-price" class="text-2xl text-purple-900">0</span>
                    </div>
                    <div class="ml-4">
                        <a href="/pembayaran" class="inline-block px-14 py-2 bg-purple-900 text-white rounded-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                            Bayar
                        </a>
                    </div>
                </div>
