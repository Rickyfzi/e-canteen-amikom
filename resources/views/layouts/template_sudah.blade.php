...
<body>
        ...
        <nav class="flex relative justify-between items-center w-full md:w-[92%] md:mx-auto px-[4%] md:px-0 text-md font-medium">
            ...
            <div class="flex flex-row ">
                <div class="flex items-center gap-10">
                    <a href="/notifications" class="text-gray-600 hover:text-gray-800 relative">
                        <img src="./assets/image/icon/notif.svg" alt="" class="w-6">
                        <img src="./assets/image/icon/dot.svg" alt="" class="absolute top-0 right-0">
                    </a>
    ...
    @yield('contents') <input type="checkbox" id="profileToggle" class="hidden">
